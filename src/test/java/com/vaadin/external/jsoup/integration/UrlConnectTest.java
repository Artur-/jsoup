package com.vaadin.external.jsoup.integration;

import com.vaadin.external.jsoup.Connection;
import com.vaadin.external.jsoup.HttpStatusException;
import com.vaadin.external.jsoup.Jsoup;
import com.vaadin.external.jsoup.UnsupportedMimeTypeException;
import com.vaadin.external.jsoup.helper.StringUtil;
import com.vaadin.external.jsoup.helper.W3CDom;
import com.vaadin.external.jsoup.nodes.Document;
import com.vaadin.external.jsoup.nodes.FormElement;
import com.vaadin.external.jsoup.parser.HtmlTreeBuilder;
import com.vaadin.external.jsoup.parser.Parser;
import com.vaadin.external.jsoup.parser.XmlTreeBuilder;
...
public class UrlConnectTest {
    ...
    public void exceptOnUnknownContentType() {
        ...
        try {
            ...
            threw = true;
            assertEquals("com.vaadin.external.jsoup.UnsupportedMimeTypeException: Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml. Mimetype=image/png, URL=http://direct.jsoup.org/rez/osi_logo.png", e.toString());
    ...
    public void throwsExceptionOnError() {
        ...
        try {
            ...
            threw = true;
            assertEquals("com.vaadin.external.jsoup.HttpStatusException: HTTP error fetching URL. Status=404, URL=http://direct.infohound.net/tools/404", e.toString());
            assertEquals(url, e.getUrl());
