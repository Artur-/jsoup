...
import com.vaadin.external.jsoup.integration.ParseTest;
...
import static com.vaadin.external.jsoup.TextUtil.LE;
...
public class W3CDomTest {
    ...
    public void simpleConversion() {
        ...
        com.vaadin.external.jsoup.nodes.Document doc = Jsoup.parse(html);
    ...
    public void convertsGoogle() throws IOException {
        ...
        com.vaadin.external.jsoup.nodes.Document doc = Jsoup.parse(in, "UTF8");
    ...
    public void namespacePreservation() throws IOException {
        ...
        com.vaadin.external.jsoup.nodes.Document jsoupDoc;
        jsoupDoc = Jsoup.parse(in, "UTF-8");

        Document doc;
        com.vaadin.external.jsoup.helper.W3CDom jDom = new com.vaadin.external.jsoup.helper.W3CDom();
