package com.vaadin.external.jsoup.examples;
 ...
 * <p><code>java -cp jsoup.jar com.vaadin.external.jsoup.examples.HtmlToPlainText url [selector]</code></p>
...
public class HtmlToPlainText {
    ...
    public static void main(String... args) throws IOException {
        Validate.isTrue(args.length == 1 || args.length == 2, "usage: java -cp jsoup.jar com.vaadin.external.jsoup.examples.HtmlToPlainText url [selector]");
