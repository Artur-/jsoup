package com.vaadin.external.jsoup.select;
...
import com.vaadin.external.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.vaadin.external.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.vaadin.external.jsoup.nodes.Attribute attribute : values) {
